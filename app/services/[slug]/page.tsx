        ...
        <section style={{ background: "var(--color-canvas-soft)", padding: "6rem 0 5rem", borderBottom: "1px solid var(--color-border)" }}>
          <div className="container" style={{ maxWidth: "760px" }}>
            <SectionFadeIn>
              ...
              <h1 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(2rem, 4vw, 3.25rem)", color: "var(--color-ink)", marginBottom: "1.25rem", lineHeight: 1.15 }}>
                {service.heroHeading}
              </h1>
            ...
            {service.sections.map((section, i) => (
              <SectionFadeIn key={section.heading} delay={i * 0.08}>
                <div style={{ marginBottom: "3rem", paddingBottom: "3rem", borderBottom: i < service.sections.length - 1 ? "1px solid var(--color-border)" : "none" }}>
                  <h2 style={{ fontFamily: "var(--font-serif)", fontSize: "clamp(1.375rem, 2vw, 1.75rem)", color: "var(--color-ink)", marginBottom: "1rem", lineHeight: 1.2 }}>
                    {section.heading}
                  </h2>
